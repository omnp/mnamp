...
descriptor.connect_port(amp, 2, ports['gain'])
descriptor.connect_port(amp, 3, ports['volume'])
descriptor.connect_port(amp, 4, ports['stages'])
descriptor.connect_port(amp, 5, ports['compensation'])
descriptor.connect_port(amp, 6, ports['drive1'])
descriptor.connect_port(amp, 7, ports['drive2'])
...
descriptor.connect_port(amp, 11, ports['tension'])
...
ports['compensation'][0] = ffi.cast('float', 25.0)
...
ports['tension'][0] = ffi.cast('float', 1.0)
